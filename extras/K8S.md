...
1. [Kubernetes best practices checklist](https://learnk8s.io/production-best-practices)
1. [Kubernetes best practices from kubernetes architect](https://github.com/diegolnasc/kubernetes-best-practices)